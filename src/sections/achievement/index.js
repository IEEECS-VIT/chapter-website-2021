  ...
  return (
    <div className={`${isDark && classes.dark}`}>
      <div className={classes.header}>
        ...
        <div className={classes.flipAnimate}>
          <b>Achieved</b>
        </div>
        <div className={classes.content}>
          ...
          members, 2 being featured in the IEEE journal itself. Not just this,
          but our members have been the recipient of the prestigious Richard E
          Merwin scholarship. It’s not just about winning but also participation
          and leadership. Our members actively work with IEEE, by volunteering
          for IEEE Compute and other such features. Our members have also served
          as the team leads for IEEE CSIS and AICSSYC’19.
        </div>
