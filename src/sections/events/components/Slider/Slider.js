    ...
    return(
        <div className={`${Style.Slider} ${props.isDark && Style.Dark}`} >
            ...
            <div className={Style.SliderFrame} style={{transform:transform}}>
                ...
                touchStart={(event)=>{touchStart(event,0)}} 
                touchEnd={touchEnd} 
                touchMove={touchMove}
                bgImg={bg1}
                isDark={props.isDark}
                ...
                img={img1}
                isLeft={true}>
                    Riviera is the Annual International Sports and Cultural Carnival of the VIT, Vellore. In the spirit of the carnival, IEEE- Computer Society organizes informal events for the students. For Riviera IEEE Computer Society organized Cyber Hunt.
                </Slide>
                <Slide
                isActive={currentIndex===1} 
                touchStart={(event)=>{touchStart(event,1)}} 
                touchEnd={touchEnd} 
                touchMove={touchMove}
                bgImg={bg2}
                isDark={props.isDark}
                ...
                img={img2}>
                    ARCS is a technical colloquium hosted by IEEE-Computer Society (VIT), which aims at improving the knowledge of the young enthusiastic minds. The 2019 edition of ARCS had five workshops, a Hack-A-Thon of 36 hours and convoke . It witnessed participation of thousands of students from all over the country.
                </Slide>
                <Slide
                isActive={currentIndex===2} 
                touchStart={(event)=>{touchStart(event,2)}} 
                touchEnd={touchEnd} 
                touchMove={touchMove}
                bgImg={bg3}
                isDark={props.isDark}
                ...
                touchStart={(event)=>{touchStart(event,3)}} 
                touchEnd={touchEnd} 
                touchMove={touchMove}
                bgImg={bg3}
                isDark={props.isDark}
                ...
                touchStart={(event)=>{touchStart(event,4)}} 
                touchEnd={touchEnd} 
                touchMove={touchMove}
                bgImg={bg3}
                isDark={props.isDark}
                ...
                img={img5}
                isLeft={true}>
                    MozDev is a hands-on workshop, which provides you an insight into the vast field of web development. Join us and learn the basics of one of the most marketable skills in the technical world. This 6-hour technical session conducted by industry experts from Mozilla Open-Source Community will ensure that you get the best possible exposure.
                </Slide>
                <Slide
                isActive={currentIndex===5} 
                touchStart={(event)=>{touchStart(event,5)}} 
                touchEnd={touchEnd} 
                touchMove={touchMove}
                bgImg={bg3}
                isDark={props.isDark}
                ...
                img={img1}>
                    Have a knack for puzzles and cryptography? Then Cicada 3302 is just the event for you, an event which has unique and brain teasing puzzle tracks, paying homage to ancient and modern methods of code-breaking, with endless fun and hidden meanings. 
                </Slide>
                <Slide
                isActive={currentIndex===6} 
                touchStart={(event)=>{touchStart(event,6)}} 
                touchEnd={touchEnd} 
                touchMove={touchMove}
                bgImg={bg3}
                isDark={props.isDark}
                ...
                img={img2}
                isLeft={true}>
                    It has always been an incredible adventure for a programmer to learn and to compete when it comes to coding. Wouldn't it be more interesting if the competition includes solving program with more than one algorithm with the help of different programming languages? Get ready with all your coding skills and you gonna enjoy the ride of this competitive programming competition, 
                </Slide>
            </div>
